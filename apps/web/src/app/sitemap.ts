...
const ROUTES = ["", "/quran", "/hadits", "/kisah", "/kitab", "/kitab-pesantren", "/amalan", "/nasakh", "/audiobook", "/harian", "/jadwal-sholat", "/donasi", "/tentang", "/syukur", "/terima-kasih", "/kontak", "/cari", "/kebijakan-privasi"];
