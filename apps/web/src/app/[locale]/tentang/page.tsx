...
export default async function TentangPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-14 sm:px-6">
      ...
      <div className="prose prose-sm mt-6 space-y-4 text-[15px] leading-relaxed text-text-primary">
      ...
      <div className="mt-10 rounded-2xl border border-accent/30 bg-(--color-card) p-6 text-center">
        <p className="font-heading text-xl text-primary dark:text-accent">{s.karyaAbadiTitle}</p>
        <p className="mt-3 text-sm leading-relaxed text-text-secondary">{s.karyaAbadiIntro}</p>
