...
const EN: KidsLabels = {
  ...
  metaDesc:
    "A bright, gentle corner for children: learn to read step by step, get to know the Arabic hijaiyah letters, and memorize the short surahs with repeat-audio.",
  title: "Al-Qur'an Kids",
  subtitle: "Let's read, memorize and learn — gently, one little step at a time 🌱",
  iqroTitle: "Learn to Read (Iqro)",
  iqroDesc: "Ten little levels, from a single Arabic letter to full tajwid drills — tap any letter to hear it in Arabic.",
  jilid: "Level",
  ...
  gamesDesc: "Learn the Arabic hijaiyah letters by playing — guess, listen, match, order.",
  gamesCta: "Play Games",
  hijaiyahTitle: "Hijaiyah Letters",
  hijaiyahDesc: "Get to know the Arabic letters — tap one to hear its name in Arabic.",
...
const ID: KidsLabels = {
  ...
  iqroDesc: "Sepuluh jilid kecil, dari satu huruf sampai latihan tajwid penuh — ketuk huruf untuk mendengarnya dalam bahasa Arab.",
  jilid: "Jilid",
...
const AR: KidsLabels = {
  ...
  iqroDesc: "عشر مراحل صغيرة، من الحرف المفرد إلى تدريبات التجويد الكاملة — انقر أيّ حرف لتسمعه بالعربية.",
  jilid: "المرحلة",
