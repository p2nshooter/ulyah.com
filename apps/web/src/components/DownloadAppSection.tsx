 ...
 * the two cards always point at whichever app is still missing. The banner
 * above the heading is decorative brand identity only (the wordmark, same
 * as the site's other Arabic-script marks shown regardless of locale) — the
 * actual translated copy is the heading/subtitle below it, never the image.
 */
  ...
  return (
    <section id="download-app" className="scroll-mt-20 px-4 py-16 sm:px-6">
      <div className="mx-auto max-w-5xl">
        <Image
          src="/brand/wordmark-banner.webp"
          alt="Ulyah"
          width={1200}
          height={800}
