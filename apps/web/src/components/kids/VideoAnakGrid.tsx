...
export function VideoAnakGrid({ locale }: { locale: string }) {
  const KIDS_L: Record<string, { worldwide: string; worldwideDesc: string; play: string; video: string; series: Record<VideoRow["series"], string> }> = {
    ...
    es: { worldwide: "Películas para niños musulmanes de todo el mundo", worldwideDesc: "Canales oficiales de películas para niños musulmanes de todo el mundo — agrupados por país, todos visibles aquí.", play: "Reproducir", video: "vídeos", series: { "doa-kisah": "Serie Súplicas e Historias", "syamil-dodo": "Cine para niños musulmanes — Syamil y Dodo", "biografi-rasul": "Biografía del Profeta ﷺ" } },
    ru: { worldwide: "Мусульманские детские фильмы со всего мира", worldwideDesc: "Официальные каналы мусульманских детских фильмов со всего мира — сгруппированы по странам, всё можно смотреть прямо здесь.", play: "Смотреть", video: "видео", series: { "doa-kisah": "Серия «Молитвы и истории»", "syamil-dodo": "Детское мусульманское кино — Шамиль и Додо", "biografi-rasul": "Жизнеописание Пророка ﷺ" } },
