...
const READER_L: Record<string, ReaderLabels> = {
  ...
  zh: {
    ...
    themes: { light: "☀️ 明亮", sepia: "📜 复古", dark: "🌙 暗色" },
    translation: "译文",
    explanation: "注释",
    died: "卒于",
    prevChapter: "上一章",
  ...
  ar: {
    ...
    resume: (o, n) => `📑 المتابعة من حيث توقفت — الباب ${o}: ${n}`,
    toc: "الأبواب",
    chapter: "باب",
    display: "🎨 العرض",
    fontSize: "حجم النص:",
    ...
    themes: { light: "☀️ فاتح", sepia: "📜 بني", dark: "🌙 داكن" },
    translation: "الترجمة",
    explanation: "الشرح",
    died: "توفي",
  ...
  ru: {
    ...
    resume: (o, n) => `📑 Продолжаем с места остановки — Глава ${o}: ${n}`,
    toc: "Главы",
    chapter: "Глава",
    display: "🎨 Вид",
    fontSize: "Размер текста:",
    theme: "Тема:",
    sizes: { sm: "Мелкий", md: "Средний", lg: "Крупный", xl: "Очень крупный" },
    themes: { light: "☀️ Светлая", sepia: "📜 Сепия", dark: "🌙 Тёмная" },
    translation: "Перевод",
  ...
  ja: {
    ...
    theme: "テーマ：",
    sizes: { sm: "小", md: "中", lg: "大", xl: "特大" },
    themes: { light: "☀️ ライト", sepia: "📜 セピア", dark: "🌙 ダーク" },
    translation: "翻訳",
    explanation: "解説",
    died: "没",
    prevChapter: "前の章",
