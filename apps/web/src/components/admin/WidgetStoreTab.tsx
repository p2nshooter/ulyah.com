 ...
 * ULYAH identity, and the open-source repos it draws from — so the plan
 * lives in the product. Widgets graduate concept → building → live here as
 * they ship. No widget carries any ad — this site runs with zero ads.
 */
    ...
    <div className="space-y-6">
      <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-card)] p-4">
        ...
        <p className="mt-3 text-xs text-[var(--color-text-secondary)]">
          ...
          sendiri. Semua beridentitas ulyah.com — situs ini tidak memuat iklan apa pun.
        </p>
      </div>
