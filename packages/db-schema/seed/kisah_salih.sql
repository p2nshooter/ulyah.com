-- AUTO-GENERATED by scripts/generate-kisah-salih-seed.ts — do not edit by hand.
-- Source content: scripts/content/kisah-salih.ts (grounded in QS. Al-A'raf, Hud, Asy-Syu'ara, Al-Ahqaf, Al-Haqqah,
...
SELECT 'Episode 1: Kaum Tsamud dan Seruan Nabi Salih', 'kisah-salih-01-kaum-tsamud-dan-seruan-salih', 'id', 'kisah-salih', 1, 1, 'Setelah kaum ''Ad binasa, Allah menjadikan kaum Tsamud sebagai kaum yang berkuasa di bumi. Mereka pun diberi seorang nabi dari kalangan mereka sendiri. Allah berfirman, "Dan kepada kaum Tsamud (Kami utus) saudara mereka, Salih. Dia berkata, ‘Wahai kaumku! Sembahlah Allah! Tidak ada tuhan (sesembahan) bagimu selain Dia’" (QS. Al-A''raf: 73).
...
Hikmah: pintu tobat selalu terbuka, dan Allah Maha Dekat lagi Maha Mengabulkan. Setiap nabi datang bukan untuk mempersulit manusia, melainkan untuk menuntun mereka kembali kepada Tuhan yang selalu siap menerima.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 73), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 1: The People of Thamud and Salih''s Call', 'kisah-salih-01-kaum-tsamud-dan-seruan-salih', 'en', 'kisah-salih', 1, 1, 'After the people of ''Ad perished, Allah made Thamud a people of power on the earth. They too were given a prophet from among themselves. Allah said, "And to Thamud [We sent] their brother Salih. He said, ''O my people, worship Allah; you have no deity other than Him''" (Qur''an 7:73).
...
Reflection: the door of repentance is always open, and Allah is ever-Near, ever-Responsive. Every prophet came not to burden people, but to guide them back to the Lord who is always ready to accept them.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 73), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 2: Nikmat Istana di Dataran dan Rumah di Gunung', 'kisah-salih-02-nikmat-rumah-di-gunung', 'id', 'kisah-salih', 2, 1, 'Salih mengingatkan kaumnya akan karunia besar yang membuat mereka istimewa. Allah berfirman, "Dan ingatlah ketika Dia menjadikan kamu pengganti-pengganti (yang berkuasa) setelah kaum ''Ad dan menempatkan kamu di bumi. Di tempat yang datar kamu dirikan istana-istana, dan gunung-gunung kamu pahat menjadi rumah-rumah. Maka ingatlah nikmat-nikmat Allah dan janganlah kamu membuat kerusakan di bumi" (QS. Al-A''raf: 74).
...
Hikmah: kepandaian dan kemakmuran adalah nikmat yang menuntut tanggung jawab. Bila disyukuri, ia menjadi keberkahan; bila membuat sombong dan berbuat kerusakan, ia berubah menjadi sebab kebinasaan.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 74), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 2: The Favor of Palaces on the Plains and Homes in the Mountains', 'kisah-salih-02-nikmat-rumah-di-gunung', 'en', 'kisah-salih', 2, 1, 'Salih reminded his people of the great favor that set them apart. Allah said, "And remember when He made you successors after the ''Ad and settled you in the land — on its plains you build palaces, and you carve homes out of the mountains. So remember the favors of Allah, and do not commit abuse on the earth, spreading corruption" (Qur''an 7:74).
...
Reflection: skill and prosperity are blessings that demand responsibility. When met with gratitude, they become a source of grace; when they breed arrogance and corruption, they turn into a cause of ruin.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 74), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 3: Mukjizat Unta Betina dan Pembagian Air', 'kisah-salih-03-mukjizat-unta-betina', 'id', 'kisah-salih', 3, 1, 'Kaum Tsamud meminta bukti, maka Allah memberi mereka sebuah tanda yang nyata: seekor unta betina yang keluar sebagai mukjizat. Salih berkata, "Inilah seekor unta betina (mukjizat) dari Allah sebagai tanda untukmu. Maka biarkanlah ia makan di bumi Allah, dan janganlah kamu mengganggunya dengan gangguan apa pun, yang menyebabkan kamu akan ditimpa azab yang pedih" (QS. Al-A''raf: 73).
...
Hikmah: Allah sering menguji manusia melalui perkara yang tampak sederhana — di sini, cukup dengan membiarkan seekor unta minum pada gilirannya. Ujian sejati bukan pada besar-kecilnya perintah, melainkan pada kesediaan hati untuk tunduk.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 54 AND number = 27), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 3: The Miracle of the She-Camel and the Sharing of the Water', 'kisah-salih-03-mukjizat-unta-betina', 'en', 'kisah-salih', 3, 1, 'The people of Thamud asked for proof, so Allah gave them a clear sign: a she-camel that came forth as a miracle. Salih said, "This is the she-camel of Allah [sent] to you as a sign. So leave her to eat within Allah''s land, and do not touch her with harm, lest there seize you a painful punishment" (Qur''an 7:73).
...
Reflection: Allah often tests people through something that seems simple — here, merely leaving a camel to drink on her turn. The real test is not in how great or small the command is, but in the heart''s willingness to submit.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 54 AND number = 27), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 4: Penyembelihan Unta dan Pembangkangan Kaum', 'kisah-salih-04-penyembelihan-unta-dan-pembangkangan', 'id', 'kisah-salih', 4, 1, 'Kesombongan akhirnya menang atas peringatan. Orang-orang yang durhaka di antara Tsamud menyembelih unta itu, menantang azab yang dijanjikan. Allah berfirman, "Kemudian mereka sembelih unta betina itu, dan berlaku angkuh terhadap perintah Tuhannya. Mereka berkata, ‘Wahai Salih! Buktikanlah ancaman kamu kepada kami, jika benar engkau salah seorang rasul’" (QS. Al-A''raf: 77).
...
Hikmah: satu perbuatan dosa yang dipelopori segelintir orang bisa membinasakan seluruh kaum bila yang lain merestui atau membiarkannya. Menentang perintah Allah dengan angkuh adalah pintu menuju kehancuran, dan tenggat tiga hari itu adalah rahmat terakhir yang mereka sia-siakan.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 77), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 4: The Slaughter of the She-Camel and the People''s Defiance', 'kisah-salih-04-penyembelihan-unta-dan-pembangkangan', 'en', 'kisah-salih', 4, 1, 'Arrogance finally won out over the warning. The wrongdoers among Thamud hamstrung and slaughtered the she-camel, challenging the promised punishment. Allah said, "So they hamstrung the she-camel and were insolent toward the command of their Lord and said, ''O Salih, bring us what you promise us, if you should be of the messengers''" (Qur''an 7:77).
...
Reflection: a single sin led by a few can destroy an entire people when the rest approve or allow it. To defy Allah''s command with arrogance is a doorway to ruin — and that three-day term was the final mercy they squandered.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 77), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 5: Azab Pekik yang Menggelegar', 'kisah-salih-05-azab-pekik-yang-menggelegar', 'id', 'kisah-salih', 5, 1, 'Setelah tenggat tiga hari berlalu, datanglah ketetapan Allah dengan cepat dan menyeluruh. Allah berfirman, "Dan satu suara keras yang mengguntur menimpa orang-orang yang zalim itu, lalu mereka mati bergelimpangan di rumahnya, seolah-olah mereka belum pernah tinggal di sana. Ingatlah, kaum Tsamud mengingkari Tuhan mereka. Ingatlah, binasalah kaum Tsamud" (QS. Hud: 67-68).
...
Hikmah: kekokohan rumah-rumah batu yang mereka pahat di gunung tidak mampu melindungi mereka dari satu suara azab. Tidak ada benteng yang dapat menahan ketetapan Allah bagi kaum yang menantang-Nya.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 67), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 5: The Thundering Shriek', 'kisah-salih-05-azab-pekik-yang-menggelegar', 'en', 'kisah-salih', 5, 1, 'After the three days passed, the decree of Allah came swiftly and completely. Allah said, "And the shriek seized those who had wronged, and they became within their homes [corpses] fallen prone, as if they had never prospered therein. Unquestionably, Thamud denied their Lord; then away with Thamud" (Qur''an 11:67-68).
...
Reflection: the sturdiness of the stone homes they carved in the mountains could not protect them from a single blast of punishment. No fortress can withstand the decree of Allah for a people who defy Him.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 67), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 6: Keselamatan Salih dan Orang-Orang Beriman', 'kisah-salih-06-keselamatan-salih-dan-orang-beriman', 'id', 'kisah-salih', 6, 1, 'Sebagaimana pada setiap kisah, Allah tidak membiarkan hamba-Nya yang beriman binasa bersama orang-orang yang zalim. Allah berfirman, "Maka ketika keputusan Kami datang, Kami selamatkan Salih dan orang-orang yang beriman bersamanya dengan rahmat dari Kami, dan (Kami selamatkan) dari kehinaan pada hari itu. Sungguh, Tuhanmu, Dialah Yang Mahakuat lagi Mahaperkasa" (QS. Hud: 66).
...
Hikmah: keselamatan sejati bukanlah pada kekuatan atau kekayaan, melainkan pada iman dan takwa. Kisah Salih menegaskan kembali janji Allah yang tak pernah berubah: orang beriman yang sabar akan selamat, dan orang zalim yang angkuh akan menuai akibat perbuatannya.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 66), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 6: The Salvation of Salih and the Believers', 'kisah-salih-06-keselamatan-salih-dan-orang-beriman', 'en', 'kisah-salih', 6, 1, 'As in every story, Allah did not let His believing servants perish alongside the wrongdoers. Allah said, "So when Our command came, We saved Salih and those who believed with him, by mercy from Us, and [saved them] from the disgrace of that day. Indeed, it is your Lord who is the Powerful, the Exalted in Might" (Qur''an 11:66).
...
Reflection: true salvation lies not in strength or wealth, but in faith and God-consciousness. The story of Salih reaffirms Allah''s unchanging promise: the patient believer will be saved, and the arrogant wrongdoer will reap the fruit of his own deeds.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 66), NULL, datetime('now');
