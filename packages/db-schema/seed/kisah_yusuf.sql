...
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (1, 'Episode 1: Mimpi Sang Nabi Muda', 'Tim Editorial ULYAH', 'ebooks/kisah-nabi-yusuf/id/kisah-nabi-yusuf-01-mimpi.pdf', 1, 'original', 'Ditulis berdasarkan QS. Yusuf 4-6 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
...
SELECT 'Episode 1: Mimpi Sang Nabi Muda', 'kisah-nabi-yusuf-01-mimpi', 'id', 'kisah-nabi-yusuf', 1, 1, 'Kisah ini dibuka dengan sebuah mimpi. Yusuf, putra Nabi Ya''qub AS, mendatangi ayahnya dan berkata, "Wahai ayahku, sungguh aku bermimpi melihat sebelas bintang, matahari, dan bulan — semuanya bersujud kepadaku" (QS. Yusuf: 4).
...
Hikmah: kebaikan yang Allah takdirkan untuk seseorang tidak selalu datang lewat jalan yang lapang. Kehati-hatian Ya''qub mengajarkan bahwa menjaga rahasia dari orang yang berpotensi dengki adalah bagian dari kebijaksanaan, bukan ketidakjujuran.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 12 AND number = 4), 1, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (2, 'Episode 1: The Young Prophet''s Dream', 'Tim Editorial ULYAH', 'ebooks/kisah-nabi-yusuf/en/kisah-nabi-yusuf-01-mimpi.pdf', 1, 'original', 'Ditulis berdasarkan QS. Yusuf 4-6 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 1: The Young Prophet''s Dream', 'kisah-nabi-yusuf-01-mimpi', 'en', 'kisah-nabi-yusuf', 1, 1, 'The story opens with a dream. Yusuf (Joseph), son of Prophet Ya''qub (Jacob), came to his father and said, "O my father, indeed I have seen eleven stars and the sun and the moon; I saw them prostrating to me" (Qur''an 12:4).
...
Reflection: the good that Allah has decreed for someone does not always arrive by an easy road. Ya''qub''s caution teaches that guarding a confidence from those who may envy it is a form of wisdom, not dishonesty.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 12 AND number = 4), 2, datetime('now');

INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (3, 'Episode 2: Sumur Pengkhianatan', 'Tim Editorial ULYAH', 'ebooks/kisah-nabi-yusuf/id/kisah-nabi-yusuf-02-sumur.pdf', 1, 'original', 'Ditulis berdasarkan QS. Yusuf 7-20 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 2: Sumur Pengkhianatan', 'kisah-nabi-yusuf-02-sumur', 'id', 'kisah-nabi-yusuf', 2, 1, 'Kecemburuan saudara-saudara Yusuf akhirnya memuncak. Mereka berkata satu sama lain, "Sesungguhnya Yusuf dan saudaranya (Bunyamin) lebih dicintai ayah daripada kita, padahal kita satu golongan yang kuat. Sungguh ayah kita dalam kekeliruan yang nyata" (QS. Yusuf: 8). Sebagian dari mereka mengusulkan untuk membunuh Yusuf, namun salah seorang di antara mereka mengusulkan jalan lain: "Janganlah kamu membunuh Yusuf, tetapi jebloskan saja dia ke dasar sumur, agar dia dipungut oleh sebagian musafir" (QS. Yusuf: 10).
...
Hikmah: kesabaran Ya''qub (sabr jamil — kesabaran yang indah) adalah teladan bagaimana menghadapi musibah besar tanpa berputus asa dari rahmat Allah.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 12 AND number = 7), 3, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (4, 'Episode 2: The Well of Betrayal', 'Tim Editorial ULYAH', 'ebooks/kisah-nabi-yusuf/en/kisah-nabi-yusuf-02-sumur.pdf', 1, 'original', 'Ditulis berdasarkan QS. Yusuf 7-20 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 2: The Well of Betrayal', 'kisah-nabi-yusuf-02-sumur', 'en', 'kisah-nabi-yusuf', 2, 1, 'The jealousy of Yusuf''s brothers finally reached its peak. They said to one another, "Joseph and his brother are more beloved to our father than we, while we are a clan. Indeed, our father is in clear error" (Qur''an 12:8). Some proposed killing Yusuf, but one of them suggested another path: "Do not kill Joseph but throw him into the bottom of the well; some travelers will pick him up" (12:10).
...
Reflection: Ya''qub''s beautiful patience (sabr jamil) models how to face great calamity without ever despairing of Allah''s mercy.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 12 AND number = 7), 4, datetime('now');

INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (5, 'Episode 3: Ujian di Istana Al-Aziz', 'Tim Editorial ULYAH', 'ebooks/kisah-nabi-yusuf/id/kisah-nabi-yusuf-03-ujian.pdf', 1, 'original', 'Ditulis berdasarkan QS. Yusuf 21-35 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 3: Ujian di Istana Al-Aziz', 'kisah-nabi-yusuf-03-ujian', 'id', 'kisah-nabi-yusuf', 3, 1, 'Yusuf dibeli oleh seorang pembesar Mesir (dikenal sebagai Al-Aziz), yang memerintahkan istrinya untuk memuliakannya, "mudah-mudahan dia bermanfaat bagi kita atau kita pungut dia sebagai anak" (QS. Yusuf: 21). Setelah dewasa, Allah menganugerahkan kepadanya hikmah dan ilmu (QS. Yusuf: 22).
...
Hikmah: menjaga kesucian diri (iffah) di hadapan godaan yang kuat, sekalipun harus membayar mahal, adalah bukti keimanan yang sesungguhnya.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 12 AND number = 21), 5, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (6, 'Episode 3: Trial in the House of Al-Aziz', 'Tim Editorial ULYAH', 'ebooks/kisah-nabi-yusuf/en/kisah-nabi-yusuf-03-ujian.pdf', 1, 'original', 'Ditulis berdasarkan QS. Yusuf 21-35 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 3: Trial in the House of Al-Aziz', 'kisah-nabi-yusuf-03-ujian', 'en', 'kisah-nabi-yusuf', 3, 1, 'Yusuf was purchased by an Egyptian nobleman (known as Al-Aziz), who instructed his wife to treat him honorably, "perhaps he will benefit us, or we will adopt him as a son" (Qur''an 12:21). As he grew to maturity, Allah granted him wisdom and knowledge (12:22).
...
Reflection: guarding one''s chastity (''iffah) in the face of powerful temptation, even at great personal cost, is true evidence of faith.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 12 AND number = 21), 6, datetime('now');

INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (7, 'Episode 4: Penjara dan Tafsir Mimpi', 'Tim Editorial ULYAH', 'ebooks/kisah-nabi-yusuf/id/kisah-nabi-yusuf-04-penjara.pdf', 1, 'original', 'Ditulis berdasarkan QS. Yusuf 36-42 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 4: Penjara dan Tafsir Mimpi', 'kisah-nabi-yusuf-04-penjara', 'id', 'kisah-nabi-yusuf', 4, 1, 'Di dalam penjara, Yusuf tidak berhenti berdakwah. Dua pemuda yang dipenjara bersamanya masing-masing bermimpi dan meminta Yusuf menafsirkannya (QS. Yusuf: 36). Sebelum menjawab, Yusuf terlebih dahulu mengajak mereka kepada tauhid: "Manakah yang baik, tuhan-tuhan yang bermacam-macam itu ataukah Allah Yang Maha Esa, Mahaperkasa?" (QS. Yusuf: 39). Ia menjelaskan bahwa apa yang mereka sembah selain Allah hanyalah nama-nama tanpa dasar kebenaran (QS. Yusuf: 40).
...
Hikmah: Yusuf memanfaatkan setiap keadaan — bahkan di dalam penjara — sebagai kesempatan untuk mengajak kepada kebenaran terlebih dahulu, sebelum memenuhi permintaan duniawi. Dakwah selalu didahulukan.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 12 AND number = 36), 7, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (8, 'Episode 4: Prison and the Interpretation of Dreams', 'Tim Editorial ULYAH', 'ebooks/kisah-nabi-yusuf/en/kisah-nabi-yusuf-04-penjara.pdf', 1, 'original', 'Ditulis berdasarkan QS. Yusuf 36-42 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 4: Prison and the Interpretation of Dreams', 'kisah-nabi-yusuf-04-penjara', 'en', 'kisah-nabi-yusuf', 4, 1, 'Even in prison, Yusuf never stopped calling others to truth. Two young men imprisoned with him each had a dream and asked Yusuf to interpret it (Qur''an 12:36). Before answering, Yusuf first invited them to the oneness of Allah: "Are dispersed lords better, or Allah, the One, the Prevailing?" (12:39). He explained that what they worshipped besides Allah were mere names without any true basis (12:40).
...
Reflection: Yusuf used every circumstance — even imprisonment — as an opportunity to call others to truth before addressing worldly requests. Da''wah always came first.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 12 AND number = 36), 8, datetime('now');

INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (9, 'Episode 5: Dari Penjara ke Singgasana', 'Tim Editorial ULYAH', 'ebooks/kisah-nabi-yusuf/id/kisah-nabi-yusuf-05-singgasana.pdf', 1, 'original', 'Ditulis berdasarkan QS. Yusuf 43-57 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 5: Dari Penjara ke Singgasana', 'kisah-nabi-yusuf-05-singgasana', 'id', 'kisah-nabi-yusuf', 5, 1, 'Bertahun-tahun kemudian, Raja Mesir bermimpi tentang tujuh sapi gemuk dimakan tujuh sapi kurus, dan tujuh tangkai gandum hijau berdampingan dengan yang kering (QS. Yusuf: 43). Tak seorang pun mampu menafsirkannya, hingga pemuda yang dahulu selamat dari penjara teringat kepada Yusuf (QS. Yusuf: 45).
...
Hikmah: kejujuran dan integritas Yusuf—yang lebih memilih membersihkan namanya lebih dulu daripada tergesa keluar dari penjara—menjadi teladan bahwa kehormatan diri lebih berharga daripada kebebasan semata.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 12 AND number = 43), 9, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (10, 'Episode 5: From Prison to the Throne', 'Tim Editorial ULYAH', 'ebooks/kisah-nabi-yusuf/en/kisah-nabi-yusuf-05-singgasana.pdf', 1, 'original', 'Ditulis berdasarkan QS. Yusuf 43-57 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 5: From Prison to the Throne', 'kisah-nabi-yusuf-05-singgasana', 'en', 'kisah-nabi-yusuf', 5, 1, 'Years later, the King of Egypt dreamed of seven fat cows being devoured by seven lean ones, and seven green ears of grain alongside withered ones (Qur''an 12:43). No one could interpret it, until the young man who had once been saved from prison finally remembered Yusuf (12:45).
...
Reflection: Yusuf''s honesty and integrity — choosing to clear his name before rushing to freedom — model that one''s honor is worth more than freedom alone.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 12 AND number = 43), 10, datetime('now');

INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (11, 'Episode 6: Pertemuan dan Pengampunan', 'Tim Editorial ULYAH', 'ebooks/kisah-nabi-yusuf/id/kisah-nabi-yusuf-06-pertemuan.pdf', 1, 'original', 'Ditulis berdasarkan QS. Yusuf 58-101 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 6: Pertemuan dan Pengampunan', 'kisah-nabi-yusuf-06-pertemuan', 'id', 'kisah-nabi-yusuf', 6, 1, 'Musim paceklik yang telah ditafsirkan Yusuf pun tiba, melanda seluruh negeri termasuk Kan''an, tempat ayah dan saudara-saudaranya tinggal. Saudara-saudara Yusuf datang ke Mesir untuk membeli bahan pangan, dan tanpa mereka sadari, mereka berhadapan langsung dengan Yusuf—yang telah mengenali mereka, sementara mereka sama sekali tidak mengenalinya (QS. Yusuf: 58).
...
Hikmah: pengampunan yang tulus—bukan balas dendam—adalah puncak akhlak seorang Nabi. Kesabaran panjang Yusuf dan Ya''qub berujung pada kebahagiaan yang jauh melampaui penderitaan yang mereka lalui, membuktikan janji Allah bahwa "bersama kesulitan ada kemudahan."', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 12 AND number = 58), 11, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (12, 'Episode 6: Reunion and Forgiveness', 'Tim Editorial ULYAH', 'ebooks/kisah-nabi-yusuf/en/kisah-nabi-yusuf-06-pertemuan.pdf', 1, 'original', 'Ditulis berdasarkan QS. Yusuf 58-101 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 6: Reunion and Forgiveness', 'kisah-nabi-yusuf-06-pertemuan', 'en', 'kisah-nabi-yusuf', 6, 1, 'The famine Yusuf had foreseen arrived, striking the whole region, including Canaan, where his father and brothers lived. Yusuf''s brothers came to Egypt to buy grain, and without realizing it, stood face to face with Yusuf himself — who recognized them at once, while they did not recognize him at all (Qur''an 12:58).
...
Reflection: sincere forgiveness — not revenge — is the pinnacle of a prophet''s character. The long patience of Yusuf and Ya''qub ultimately gave way to a joy far greater than the suffering they endured, a living proof of Allah''s promise that "with hardship comes ease."', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 12 AND number = 58), 12, datetime('now');
