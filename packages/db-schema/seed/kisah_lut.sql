-- AUTO-GENERATED by scripts/generate-kisah-lut-seed.ts — do not edit by hand.
-- Source content: scripts/content/kisah-lut.ts (grounded in QS. Al-A'raf, Hud, Asy-Syu'ara, Al-Ahqaf, Al-Haqqah,
...
Hikmah: seorang nabi tidak berdiam diri melihat kemungkaran yang merusak fitrah manusia. Ia memperingatkan dengan jelas, bukan karena benci kepada kaumnya, melainkan karena kasih sayang agar mereka selamat dari akibat perbuatan mereka sendiri.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 80), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 1: Prophet Lut Warns His People', 'kisah-lut-01-peringatan-terhadap-kemungkaran', 'en', 'kisah-lut', 1, 1, 'Prophet Lut was a kinsman of Prophet Ibrahim, sent to the people of a town who committed an immorality no nation before them had ever done. Allah said, "And [We had sent] Lot, when he said to his people, ''Do you commit such immorality as no one has preceded you with from among the worlds?''" (Qur''an 7:80).
...
Reflection: a prophet does not stay silent before an evil that corrupts the very nature of humankind. He warns clearly — not out of hatred for his people, but out of compassion, that they might be saved from the consequences of their own deeds.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 80), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 2: Penolakan dan Ancaman Mengusir Lut', 'kisah-lut-02-penolakan-dan-ancaman-pengusiran', 'id', 'kisah-lut', 2, 1, 'Alih-alih sadar, kaum Lut menjawab peringatan dengan kesombongan dan ancaman. Allah berfirman, "Dan (ingatlah kisah) Lut, ketika dia berkata kepada kaumnya, ‘Mengapa kamu mengerjakan perbuatan keji, padahal kamu melihat (kekejiannya)? Mengapa kamu mendatangi laki-laki untuk (memenuhi) syahwat(mu), bukan (mendatangi) perempuan? Sungguh, kamu adalah kaum yang tidak mengetahui (akibat perbuatanmu)’" (QS. An-Naml: 54-55).
...
Hikmah: ketika hati telah rusak, kebaikan justru dianggap kesalahan dan kesucian dianggap aib. Mereka ingin mengusir orang-orang baik agar bebas dalam keburukan — sebuah tanda betapa jauh mereka telah tersesat.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 27 AND number = 54), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 2: Rejection and the Threat to Expel Lut', 'kisah-lut-02-penolakan-dan-ancaman-pengusiran', 'en', 'kisah-lut', 2, 1, 'Rather than come to their senses, the people of Lut answered the warning with arrogance and threats. Allah said, "And [mention] Lot, when he said to his people, ''Do you commit immorality while you are seeing? Do you indeed approach men with desire instead of women? Rather, you are a people behaving ignorantly''" (Qur''an 27:54-55).
...
Reflection: when the heart is corrupted, goodness itself is seen as a fault and purity as a disgrace. They wished to drive out the good people so they could be free in their evil — a sign of how far astray they had gone.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 27 AND number = 54), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 3: Kedatangan Para Tamu dan Kegelisahan Lut', 'kisah-lut-03-kedatangan-para-tamu', 'id', 'kisah-lut', 3, 1, 'Allah mengutus para malaikat dalam wujud tamu-tamu menuju negeri Lut, sesudah mereka menemui Ibrahim. Kedatangan mereka membuat Lut cemas, karena ia tahu keburukan kaumnya. Allah berfirman, "Dan ketika para utusan Kami (para malaikat) datang kepada Lut, dia merasa bersedih hati karena (kedatangan) mereka, dan merasa tidak mempunyai kekuatan untuk melindungi mereka, dan dia berkata, ‘Ini hari yang sangat sulit’" (QS. Hud: 77).
...
Hikmah: seorang yang saleh merasakan beban berat ketika kemungkaran merajalela di sekitarnya. Kepedihan Lut menunjukkan hati yang hidup — hati yang tidak pernah terbiasa dengan dosa, meski hidup di tengah kaum yang tenggelam di dalamnya.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 77), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 3: The Coming of the Guests and Lut''s Distress', 'kisah-lut-03-kedatangan-para-tamu', 'en', 'kisah-lut', 3, 1, 'Allah sent the angels in the form of guests toward the town of Lut, after they had visited Ibrahim. Their arrival made Lut anxious, for he knew the evil of his people. Allah said, "And when Our messengers, [the angels], came to Lot, he was anguished for them and felt for them great discomfort and said, ''This is a trying day''" (Qur''an 11:77).
...
Reflection: a righteous person feels a heavy burden when evil runs rampant around him. Lut''s grief shows a living heart — one never comfortable with sin, though he lived amid a people drowning in it.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 77), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 4: Para Malaikat Menyingkap Jati Diri', 'kisah-lut-04-malaikat-menyingkap-jati-diri', 'id', 'kisah-lut', 4, 1, 'Di saat Lut berada dalam puncak kegelisahan, para tamu itu menyingkap jati diri mereka yang sebenarnya. Mereka adalah malaikat yang diutus untuk menyelamatkan Lut dan menurunkan azab. Allah berfirman, "Mereka (para malaikat) berkata, ‘Wahai Lut! Sesungguhnya kami adalah para utusan Tuhanmu, mereka tidak akan dapat mengganggu kamu’" (QS. Hud: 81).
...
Hikmah: pertolongan Allah datang tepat pada saat hamba-Nya merasa paling lemah. Lut yang tadinya berharap punya kekuatan untuk melindungi tamunya, ternyata tamu-tamu itulah yang datang untuk melindunginya — sebuah pengingat bahwa penolong sejati hanyalah Allah.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 81), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 4: The Angels Reveal Themselves', 'kisah-lut-04-malaikat-menyingkap-jati-diri', 'en', 'kisah-lut', 4, 1, 'At the peak of Lut''s distress, the guests revealed their true identity. They were angels sent to save Lut and to bring down the punishment. Allah said, "The angels said, ''O Lot, indeed we are messengers of your Lord; [the mob] will never reach you''" (Qur''an 11:81).
...
Reflection: Allah''s help arrives at the very moment His servant feels weakest. Lut, who had wished for strength to protect his guests, found that it was those guests who had come to protect him — a reminder that the true Helper is Allah alone.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 81), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 5: Negeri yang Dijungkirbalikkan', 'kisah-lut-05-negeri-yang-dijungkirbalikkan', 'id', 'kisah-lut', 5, 1, 'Ketika waktu subuh tiba, datanglah azab yang menghancurkan seluruh negeri itu dengan cara yang belum pernah terjadi. Allah berfirman, "Maka ketika keputusan Kami datang, Kami menjungkirbalikkannya (negeri kaum Lut), dan Kami hujani mereka dengan batu dari tanah yang terbakar secara bertubi-tubi, yang diberi tanda dari Tuhanmu. Dan siksaan itu tiadalah jauh dari orang yang zalim" (QS. Hud: 82-83).
...
Hikmah: dosa yang dibiarkan tumbuh subur hingga menjadi kebanggaan sebuah kaum akan mengundang azab yang setimpal. Negeri kaum Lut menjadi bukti sejarah yang Allah tinggalkan sebagai peringatan bagi setiap generasi sesudahnya.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 82), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 5: The Town Turned Upside Down', 'kisah-lut-05-negeri-yang-dijungkirbalikkan', 'en', 'kisah-lut', 5, 1, 'When the dawn came, the punishment descended and destroyed the whole town in a way never seen before. Allah said, "So when Our command came, We made its highest part its lowest and rained upon them stones of layered hard clay, one after another, marked from your Lord. And it is not far from the wrongdoers" (Qur''an 11:82-83).
...
Reflection: a sin left to flourish until it becomes a people''s pride invites a fitting punishment. The town of Lut''s people became a historical proof that Allah left behind as a warning for every generation after them.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 82), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 6: Keselamatan Lut kecuali Istrinya', 'kisah-lut-06-keselamatan-lut-kecuali-istrinya', 'id', 'kisah-lut', 6, 1, 'Di tengah kehancuran itu, Allah menyelamatkan Nabi Lut beserta keluarga yang beriman, kecuali istrinya yang berpihak kepada kaumnya. Allah berfirman, "Maka Kami selamatkan dia beserta keluarganya, kecuali istrinya. Kami telah menentukan dia termasuk orang-orang yang tertinggal (dibinasakan). Dan Kami hujani mereka dengan hujan (batu). Maka betapa buruk hujan yang menimpa orang-orang yang telah diberi peringatan itu" (QS. An-Naml: 57-58).
...
Hikmah: keselamatan di sisi Allah ditentukan oleh iman dan amal, bukan oleh hubungan darah atau pernikahan. Istri Lut binasa bukan karena ia bukan istri nabi, melainkan karena hatinya berpihak kepada keburukan kaumnya.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 27 AND number = 57), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 6: The Salvation of Lut Except His Wife', 'kisah-lut-06-keselamatan-lut-kecuali-istrinya', 'en', 'kisah-lut', 6, 1, 'Amid that destruction, Allah saved Prophet Lut and his believing family, except his wife who sided with his people. Allah said, "So We saved him and his family, except for his wife; We destined her to be of those who remained behind. And We rained upon them a rain [of stones]; and evil was the rain of those who were warned" (Qur''an 27:57-58).
...
Reflection: salvation with Allah is determined by faith and deeds, not by ties of blood or marriage. Lut''s wife perished not because she was not a prophet''s wife, but because her heart sided with the evil of her people.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 27 AND number = 57), NULL, datetime('now');
