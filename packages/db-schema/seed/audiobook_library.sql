-- AUTO-GENERATED by scripts/generate-audiobook-library-seed.mjs — edit the
...
INSERT OR IGNORE INTO categories (name, slug, parent_id, auto_created) VALUES ('Fiqih Pernikahan', 'fiqih-pernikahan', NULL, 0);
INSERT OR IGNORE INTO categories (name, slug, parent_id, auto_created) VALUES ('Fiqih Warisan', 'fiqih-warisan', NULL, 0);
INSERT OR IGNORE INTO categories (name, slug, parent_id, auto_created) VALUES ('Pondasi Iman', 'pondasi-iman', NULL, 0);

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Rukun dan Syarat Sah Pernikahan dalam Islam', 'fiqih-nikah-rukun-syarat', 'id', (SELECT id FROM categories WHERE slug = 'fiqih-pernikahan'), 'Pernikahan dalam Islam bukan sekadar peristiwa sosial, melainkan ibadah dan perjanjian yang kokoh — Al-Qur''an menyebutnya "mitsaqan ghalizha", perjanjian yang berat (QS An-Nisa'': 21). Karena itu Islam menetapkan rukun-rukun yang harus terpenuhi agar sebuah akad nikah sah.
...
Hikmah dari seluruh rangkaian ini terasa jelas: Islam menutup pintu main-main dalam urusan membangun keluarga. Sejak pinangan sampai mahar, semuanya dirancang untuk menumbuhkan penghormatan, kejelasan, dan tanggung jawab. Bagi yang sedang menempuh jalan menuju pernikahan, inilah bekal adabnya: luruskan niat, tempuh jalurnya dengan terhormat, sederhanakan tuntutan, dan mohon keberkahan dari Allah — karena rumah tangga yang baik dimulai jauh sebelum hari akadnya.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Hak dan Kewajiban Suami Istri', 'fiqih-nikah-hak-kewajiban', 'id', (SELECT id FROM categories WHERE slug = 'fiqih-pernikahan'), 'Ketika akad nikah selesai diucapkan, lahirlah serangkaian hak dan kewajiban yang saling berbalasan antara suami dan istri. Al-Qur''an merangkum prinsipnya dengan indah: "Dan mereka (para istri) mempunyai hak yang seimbang dengan kewajibannya menurut cara yang makruf" (QS Al-Baqarah: 228).
...
Rumah tangga dalam Islam bukan arena menuntut hak semata, melainkan berlomba menunaikan kewajiban. Ketika suami sibuk menunaikan kewajibannya dan istri sibuk menunaikan kewajibannya, hak masing-masing terpenuhi tanpa perlu diminta — dan di situlah sakinah, mawaddah, dan rahmah menemukan tempat tumbuhnya.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Mengenal Ilmu Faraidh: Warisan yang Diatur Langsung oleh Allah', 'fiqih-waris-pengantar', 'id', (SELECT id FROM categories WHERE slug = 'fiqih-warisan'), 'Di antara seluruh cabang fiqih, hukum warisan menempati kedudukan yang istimewa: bagian-bagiannya ditetapkan langsung oleh Allah di dalam Al-Qur''an, terperinci sampai ke angka-angkanya. Ayat-ayat waris dalam surah An-Nisa'' ayat 11, 12, dan 176 menyebut bagian anak, orang tua, pasangan, dan saudara — lalu ditutup dengan peringatan yang menggetarkan: itulah batas-batas Allah, dan siapa yang menaatinya akan dimasukkan ke dalam surga.
...
Kasus-kasus nyata sering lebih rumit dari contoh dasar — ada kakek, nenek, saudara seibu, dan berbagai kombinasi yang memerlukan perhitungan khusus. Karena itu para ulama menyusun kaidah-kaidah rinci selama berabad-abad. Untuk kebutuhan praktis, gunakan Kalkulator Waris ULYAH sebagai langkah awal, lalu kuatkan dengan bertanya kepada ustadz atau lembaga yang menguasai faraidh sebelum pembagian dilakukan.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Wasiat, Hibah, dan Batasannya dalam Hukum Waris', 'fiqih-waris-wasiat-hibah', 'id', (SELECT id FROM categories WHERE slug = 'fiqih-warisan'), 'Banyak sengketa warisan bermula dari kerancuan tiga istilah: warisan, wasiat, dan hibah. Ketiganya sama-sama memindahkan harta, tetapi hukum dan waktunya berbeda — dan Islam mengatur ketiganya dengan cermat.
...
Dari sini tampak hikmahnya: hibah memberi keleluasaan di masa hidup dengan syarat keadilan; wasiat memberi ruang kebaikan untuk pihak di luar ahli waris — kerabat jauh, anak asuh, lembaga sosial — dengan pagar sepertiga; dan faraidh menjaga hak keluarga inti dari kesewenang-wenangan. Tiga pintu yang saling melengkapi, semuanya bermuara pada satu hal: harta berpindah tanpa meninggalkan luka.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Enam Rukun Iman: Fondasi Aqidah Seorang Muslim', 'pondasi-iman-rukun-iman', 'id', (SELECT id FROM categories WHERE slug = 'pondasi-iman'), 'Ketika Malaikat Jibril datang dalam rupa seorang laki-laki dan bertanya kepada Rasulullah shallallahu alaihi wa sallam tentang iman, beliau menjawab: "Iman adalah engkau beriman kepada Allah, para malaikat-Nya, kitab-kitab-Nya, para rasul-Nya, hari akhir, dan engkau beriman kepada takdir yang baik maupun yang buruk." Hadits sahih riwayat Muslim ini menjadi rumusan enam rukun iman yang dikenal setiap Muslim.
...
Enam rukun ini bukan daftar hafalan anak sekolah semata. Ia adalah cara pandang yang utuh terhadap hidup: dari mana kita berasal, siapa yang mengawasi kita, petunjuk mana yang kita pegang, teladan siapa yang kita ikuti, ke mana kita menuju, dan bagaimana menyikapi apa yang menimpa kita. Siapa yang menghayatinya, kokohlah bangunannya menghadapi badai apa pun.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Makna Dua Kalimat Syahadat', 'pondasi-iman-syahadat', 'id', (SELECT id FROM categories WHERE slug = 'pondasi-iman'), 'Gerbang masuk Islam hanya satu kalimat: Asyhadu an laa ilaaha illallah, wa asyhadu anna Muhammadar Rasulullah — aku bersaksi tiada tuhan yang berhak disembah selain Allah, dan aku bersaksi Muhammad adalah utusan Allah. Kalimat yang ringan diucapkan, tetapi para ulama menyebutnya kalimat paling berat dalam timbangan.
...
Rezeki yang lewat bukan salah jalan; musibah yang datang bukan tanpa hitungan. Yang menjadi tanggung jawab kita hanyalah ikhtiar dan sikap — dan pada dua hal itulah nilai kita di sisi Allah ditentukan.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Ikhlas: Ruh Setiap Amal', 'hikmah-ikhlas-ruh-amal', 'id', (SELECT id FROM categories WHERE slug = 'hikmah-harian'), 'Hadits pertama yang dipilih Imam Bukhari untuk membuka kitab sahihnya, dan yang dipilih Imam Nawawi membuka Arba''in-nya, adalah sabda Rasulullah shallallahu alaihi wa sallam: "Innamal-a''malu bin-niyyat" — sesungguhnya amal-amal itu tergantung pada niatnya, dan setiap orang mendapat sesuai yang ia niatkan (HR Bukhari dan Muslim). Para ulama menyebut hadits ini sepertiga ilmu, karena hampir seluruh amal manusia berpangkal pada gerak hati.
...
Ikhlas adalah pekerjaan seumur hidup, bukan pencapaian sekali jadi. Sufyan Ats-Tsauri berkata bahwa tidak ada yang lebih berat beliau perangi daripada niatnya sendiri, karena ia selalu berbolak-balik. Maka mulailah setiap pagi dengan meluruskan niat, dan tutup setiap amal dengan doa agar diterima. Allah tidak menilai rupa dan harta kita — Dia menilai hati dan amal kita.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Sabar dan Syukur: Dua Sayap Seorang Mukmin', 'hikmah-sabar-syukur', 'id', (SELECT id FROM categories WHERE slug = 'hikmah-harian'), 'Hidup manusia hanya berputar di antara dua keadaan: sesuatu yang ia sukai, atau sesuatu yang tidak ia sukai. Islam memberi bekal untuk keduanya — syukur untuk yang pertama, sabar untuk yang kedua. Karena itu sebagian ulama berkata: iman itu dua bagian; separuhnya sabar, separuhnya syukur.
...
Lisan yang terjaga bukan lisan yang bisu, melainkan lisan yang setiap keluarnya bernilai: kata yang jujur, nasihat yang lembut, doa yang tulus, dan dzikir yang membasahi. Mulailah hari ini: satu ghibah yang ditahan, satu komentar pedas yang tidak jadi dikirim — semuanya tercatat sebagai kebaikan di sisi Allah.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Ayat-Ayat Kesabaran: Bagaimana Al-Qur''an Menguatkan Jiwa', 'tafsir-tematik-sabar', 'id', (SELECT id FROM categories WHERE slug = 'tafsir-tematik'), 'Kata sabar dan turunannya disebut dalam Al-Qur''an lebih dari sembilan puluh kali — jauh lebih sering daripada banyak perintah lainnya. Frekuensi ini sendiri adalah tafsir: Allah tahu hamba-Nya akan sangat sering membutuhkannya.
...
Membaca ayat-ayat ini bukan untuk sekadar tahu, tetapi untuk diambil sebagai bekal: ketika ujianmu terasa berat, bukalah kembali ayat-ayat ini — karena beginilah cara Allah sendiri menguatkan jiwa hamba-Nya.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Rezeki dalam Al-Qur''an: Antara Ikhtiar dan Tawakal', 'tafsir-tematik-rezeki', 'id', (SELECT id FROM categories WHERE slug = 'tafsir-tematik'), 'Kekhawatiran soal rezeki adalah kecemasan paling universal manusia — dan Al-Qur''an menjawabnya berulang-ulang dengan penegasan yang menenangkan: "Tidak ada satu makhluk melata pun di bumi melainkan Allah-lah yang menanggung rezekinya" (QS Hud: 6). Jaminan ini datang dari Dzat yang menyebut diri-Nya Ar-Razzaq — Maha Pemberi Rezeki — "Sesungguhnya Allah, Dialah Maha Pemberi rezeki yang mempunyai kekuatan lagi sangat kokoh" (QS Adz-Dzariyat: 58).
...
Yang terakhir, Al-Qur''an meluruskan ukuran. Rezeki yang dilapangkan bukan tanda kemuliaan, dan yang disempitkan bukan tanda kehinaan (QS Al-Fajr: 15-16) — keduanya ujian. Maka rumus mukmin sederhana: ikhtiar maksimal seolah semua tergantung usahamu, hati bersandar penuh seolah semua tergantung Allah — karena memang keduanya benar.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Doa-Doa Para Nabi dalam Al-Qur''an', 'tafsir-tematik-doa-nabi', 'id', (SELECT id FROM categories WHERE slug = 'tafsir-tematik'), 'Salah satu hadiah terindah Al-Qur''an adalah rekaman doa para nabi — kalimat-kalimat yang pernah naik dari hati manusia-manusia terbaik pada saat-saat tersulit mereka, lalu diabadikan Allah agar kita ikut mengucapkannya.
...
Hafalkanlah satu saja dari doa-doa ini, dan bawalah dalam sujudmu. Kalimat yang pernah menyelamatkan seorang nabi dari perut ikan, insya Allah cukup kuat membawa hajatmu naik ke langit yang sama.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Abu Bakar Ash-Shiddiq: Iman yang Tak Pernah Ragu', 'kisah-sahabat-abu-bakar-audio', 'id', (SELECT id FROM categories WHERE slug = 'kisah-sahabat'), 'Jika iman seluruh umat ditimbang dengan iman satu orang ini, kata sebagian ulama salaf, iman Abu Bakar lebih berat. Ia bukan yang paling kaya, bukan yang paling perkasa — kelebihannya ada pada sesuatu yang tak terlihat: hati yang tidak pernah ragu.
...
Warisannya untuk kita satu kalimat: iman itu bukan soal siapa paling banyak amalnya hari ini, tetapi siapa yang hatinya paling lurus dan yakin kepada Allah dan Rasul-Nya — lalu amal mengalir dari keyakinan itu.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Umar bin Khattab: Keadilan yang Menggetarkan', 'kisah-sahabat-umar-audio', 'id', (SELECT id FROM categories WHERE slug = 'kisah-sahabat'), 'Sebelum Islam, Umar bin Khattab adalah salah satu penentangnya yang paling keras. Maka ketika Rasulullah shallallahu alaihi wa sallam berdoa, "Ya Allah, muliakan Islam dengan salah satu dari dua Umar," dan doa itu jatuh pada Umar bin Khattab — sejarah berubah arah. Sejak keislamannya, kaum Muslimin yang tadinya sembunyi-sembunyi mulai berani shalat terang-terangan di sisi Ka''bah.
...
Dari Umar kita belajar bahwa kekuasaan dalam Islam bukan kehormatan yang dinikmati, melainkan beban yang kelak ditanya — dan bahwa rasa takut kepada Allah adalah sumber keberanian paling murni di hadapan manusia.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Bilal bin Rabah: Suara Iman yang Tak Bisa Dibungkam', 'kisah-sahabat-bilal-audio', 'id', (SELECT id FROM categories WHERE slug = 'kisah-sahabat'), 'Di bawah terik matahari Makkah, di atas pasir yang membakar, seorang budak berkulit hitam ditindih batu besar oleh tuannya. Ia disiksa untuk satu kesalahan: beriman kepada Allah. Umayyah bin Khalaf memaksanya kembali menyembah Lata dan Uzza, tetapi dari dada yang sesak itu hanya keluar dua kata yang mengguncang sejarah: "Ahad... Ahad..." — Yang Maha Esa, Yang Maha Esa.
...
Dari Bilal kita belajar bahwa iman adalah kemerdekaan yang sesungguhnya: tubuh boleh dirantai, tetapi "Ahad" yang bersemayam di hati tidak bisa disentuh siapa pun. Dan bahwa di sisi Allah, derajat tidak diwariskan oleh darah — ia diraih oleh takwa, kesabaran, dan amal yang tulus.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Uwais Al-Qarni: Terkenal di Langit, Tak Dikenal di Bumi', 'kisah-tabiin-uwais-audio', 'id', (SELECT id FROM categories WHERE slug = 'kisah-tabiin'), 'Ada seorang tabi''in yang tidak pernah bertemu Rasulullah shallallahu alaihi wa sallam, tetapi namanya disebut-sebut oleh beliau kepada para sahabat. Namanya Uwais bin Amir Al-Qarni, dari Yaman.
...
Dari Hasan Al-Bashri kita belajar bahwa nasihat yang menggerakkan bukan lahir dari kepandaian merangkai kata, melainkan dari hati yang lebih dulu mengamalkannya. Zuhud bukan membenci dunia, tetapi tidak membiarkan dunia bertahta di hati — dan itulah yang membuat kata-katanya tetap hidup tiga belas abad kemudian.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Sufyan Ats-Tsauri: Amirul Mukminin dalam Hadits', 'kisah-tabtab-sufyan-audio', 'id', (SELECT id FROM categories WHERE slug = 'kisah-tabiin-tabiin'), 'Pada generasi ketiga umat ini — tabi''ut tabi''in, murid dari murid para sahabat — berdiri seorang ulama yang oleh para ahli hadits digelari Amirul Mukminin fil Hadits, pemimpin orang beriman dalam ilmu hadits: Sufyan bin Sa''id Ats-Tsauri, lahir di Kufah tahun 97 hijriah.
...
Dari Sufyan Ats-Tsauri kita belajar keseimbangan yang langka: puncak kepakaran dan puncak kehati-hatian dalam satu jiwa. Semakin tinggi ilmunya, semakin rendah hatinya; semakin besar namanya, semakin jauh ia dari pintu-pintu yang bisa merusak keikhlasannya. Ilmu tanpa wara'' hanyalah kecerdasan; dan Sufyan menunjukkan seperti apa jadinya jika keduanya bersatu.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Abdullah bin Al-Mubarak: Ulama, Saudagar, dan Mujahid', 'kisah-tabtab-ibnul-mubarak-audio', 'id', (SELECT id FROM categories WHERE slug = 'kisah-tabiin-tabiin'), 'Jika ada satu nama dari generasi tabi''ut tabi''in yang membantah anggapan bahwa kesalehan berarti menjauh dari dunia kerja, dialah Abdullah bin Al-Mubarak — ulama besar Khurasan, lahir di Marw tahun 118 hijriah, dari ayah keturunan Turk dan ibu dari Khawarizm.
...
Dari Ibnul Mubarak kita belajar bahwa dunia dan akhirat tidak harus bermusuhan: harta di tangan orang saleh menjadi sayap kebaikan, dan ilmu yang dipikul jiwa pemberani menjadi cahaya yang menjaga umat. Kuncinya satu — semua porosnya ikhlas karena Allah.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Imam Asy-Syafi''i: Perjalanan Ilmu dari Gaza ke Mesir', 'kisah-ulama-syafii-audio', 'id', (SELECT id FROM categories WHERE slug = 'kisah-ulama-dunia'), 'Muhammad bin Idris Asy-Syafi''i lahir di Gaza tahun 150 hijriah — tahun wafatnya Imam Abu Hanifah, seolah sejarah sedang melakukan serah terima. Ayahnya wafat saat ia kecil; ibunya yang miskin membawanya ke Makkah, tanah asal keluarganya yang bernasab sampai kepada kakek buyut Rasulullah shallallahu alaihi wa sallam.
...
Dari Imam Syafi''i kita belajar bahwa kemiskinan bukan penghalang ilmu, bahwa menggabungkan dua pendekatan yang tampak bertentangan bisa melahirkan karya terbesar, dan bahwa puncak kealiman justru ditandai kerendahan hati untuk berkata: aku mungkin salah.', 0, 'published', 'html', 'published', datetime('now'));

INSERT OR IGNORE INTO stories (title, slug, lang, category_id, body, ai_generated, qc_status, source_format, status, published_at)
VALUES ('Imam Al-Bukhari: Penjaga Sabda Nabi', 'kisah-ulama-bukhari-audio', 'id', (SELECT id FROM categories WHERE slug = 'kisah-ulama-dunia'), 'Di kota Bukhara — kini di Uzbekistan — lahir pada tahun 194 hijriah seorang anak bernama Muhammad bin Ismail. Ayahnya, seorang ulama, wafat saat ia kecil; masa kecilnya sempat diuji dengan kebutaan, dan menurut riwayat yang masyhur penglihatannya kembali setelah doa ibunya yang tak putus-putus. Anak itu kelak dikenal dunia dengan satu nama: Imam Al-Bukhari.
