-- AUTO-GENERATED by scripts/generate-kisah-dzulqarnain-seed.ts — do not edit by hand.
-- Source content: scripts/content/kisah-dzulqarnain.ts (grounded in QS. Al-Kahf
-- 18:83-98, quran-json CC-BY-4.0). See docs/CONTENT-POLICY.md.
...
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (200, 'Dzulqarnain: Kekuasaan yang Diberikan Allah dan Perjalanan ke Barat', 'Tim Editorial ULYAH', 'ebooks/kisah-dzulqarnain/id/kisah-dzulqarnain-01-kekuasaan-dan-perjalanan-barat.pdf', 5, 'original', 'Ditulis berdasarkan QS. Al-Kahf 83-88 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
...
SELECT 'Dzulqarnain: Kekuasaan yang Diberikan Allah dan Perjalanan ke Barat', 'kisah-dzulqarnain-01-kekuasaan-dan-perjalanan-barat', 'id', 'kisah-dzulqarnain', 1, 5, 'Sebagian orang bertanya kepada Nabi Muhammad tentang Dzulqarnain. Maka Allah memerintahkan agar dibacakan kepada mereka sebagian kisahnya sebagai pelajaran. Allah menerangkan bahwa Dia telah memberi Dzulqarnain kedudukan yang kokoh di muka bumi, dan menganugerahinya jalan untuk mencapai segala sesuatu yang ia kehendaki. Ia pun menempuh suatu jalan.
...
Hikmah: Kekuasaan yang sejati adalah amanah untuk menegakkan keadilan, bukan alat untuk menindas. Dzulqarnain diberi "jalan menuju segala sesuatu", namun ia tetap tunduk kepada Allah dan mengembalikan urusan akhir setiap manusia kepada-Nya. Pemimpin yang beriman menghukum kezaliman dengan adil dan memperlakukan orang saleh dengan lembut.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 18 AND number = 83), 200, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (201, 'Dhul-Qarnayn: God-Given Authority and the Journey Westward', 'Tim Editorial ULYAH', 'ebooks/kisah-dzulqarnain/en/kisah-dzulqarnain-01-kekuasaan-dan-perjalanan-barat.pdf', 5, 'original', 'Ditulis berdasarkan QS. Al-Kahf 83-88 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Dhul-Qarnayn: God-Given Authority and the Journey Westward', 'kisah-dzulqarnain-01-kekuasaan-dan-perjalanan-barat', 'en', 'kisah-dzulqarnain', 1, 5, 'Some people asked the Prophet Muhammad about Dhul-Qarnayn. God commanded that a portion of his account be recited to them as a lesson. God explained that He had established Dhul-Qarnayn firmly upon the earth and granted him a means to reach everything he intended. So he followed a way.
...
Reflection: True power is a trust for upholding justice, not a tool for oppression. Dhul-Qarnayn was given "a way to everything," yet he stayed submissive to God and left each person''s final reckoning to Him. The believing leader punishes wrongdoing with fairness and treats the righteous with gentleness.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 18 AND number = 83), 201, datetime('now');

INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (202, 'Perjalanan ke Timur: Kaum di Bawah Terik Matahari', 'Tim Editorial ULYAH', 'ebooks/kisah-dzulqarnain/id/kisah-dzulqarnain-02-perjalanan-timur.pdf', 5, 'original', 'Ditulis berdasarkan QS. Al-Kahf 89-91 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Perjalanan ke Timur: Kaum di Bawah Terik Matahari', 'kisah-dzulqarnain-02-perjalanan-timur', 'id', 'kisah-dzulqarnain', 2, 5, 'Setelah menegakkan keadilan di ujung barat, Dzulqarnain kembali menempuh suatu jalan. Ia berjalan menuju arah yang lain, ke tempat terbitnya matahari.
...
Hikmah: Betapapun luas kekuasaan dan jauh perjalanan seseorang, ia tidak pernah keluar dari liputan ilmu Allah. Keadilan sejati tidak berubah karena tempat atau keadaan kaum yang dihadapi — Dzulqarnain memperlakukan kaum di timur dan di barat dengan timbangan yang sama. Dan Allah senantiasa Maha Mengetahui atas segala yang kita miliki dan kita perbuat.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 18 AND number = 89), 202, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (203, 'The Journey Eastward: A People Beneath the Blazing Sun', 'Tim Editorial ULYAH', 'ebooks/kisah-dzulqarnain/en/kisah-dzulqarnain-02-perjalanan-timur.pdf', 5, 'original', 'Ditulis berdasarkan QS. Al-Kahf 89-91 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'The Journey Eastward: A People Beneath the Blazing Sun', 'kisah-dzulqarnain-02-perjalanan-timur', 'en', 'kisah-dzulqarnain', 2, 5, 'After establishing justice at the western edge, Dhul-Qarnayn once again followed a way. He travelled in another direction, toward the place where the sun rises.
...
Reflection: However vast a person''s power and however far his journey, he never steps outside the encompassing knowledge of God. True justice does not change with place or with the condition of the people one faces — Dhul-Qarnayn treated east and west by the same measure. And God is ever fully aware of all we possess and all we do.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 18 AND number = 89), 203, datetime('now');

INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (204, 'Di Antara Dua Gunung: Keluhan tentang Ya''juj dan Ma''juj', 'Tim Editorial ULYAH', 'ebooks/kisah-dzulqarnain/id/kisah-dzulqarnain-03-antara-dua-gunung-yajuj-majuj.pdf', 5, 'original', 'Ditulis berdasarkan QS. Al-Kahf 92-95 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Di Antara Dua Gunung: Keluhan tentang Ya''juj dan Ma''juj', 'kisah-dzulqarnain-03-antara-dua-gunung-yajuj-majuj', 'id', 'kisah-dzulqarnain', 3, 5, 'Dzulqarnain kembali menempuh suatu jalan. Ia terus berjalan hingga sampai di antara dua buah gunung. Di sana ia mendapati suatu kaum yang hampir tidak dapat memahami pembicaraan, karena perbedaan bahasa dan keterasingan mereka.
...
Hikmah: Orang yang telah dicukupkan Allah tidak menjadikan kebaikan sebagai ladang mencari upah. Dzulqarnain menolak harta dan justru mengajak kaum itu bekerja bersama — sebab pertolongan yang paling mulia adalah yang memberdayakan orang lain, bukan yang menjadikan mereka bergantung. Kekuatan sejati dipakai untuk membendung kerusakan, bukan menumpuk kekayaan.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 18 AND number = 92), 204, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (205, 'Between the Two Mountains: The Complaint of Gog and Magog', 'Tim Editorial ULYAH', 'ebooks/kisah-dzulqarnain/en/kisah-dzulqarnain-03-antara-dua-gunung-yajuj-majuj.pdf', 5, 'original', 'Ditulis berdasarkan QS. Al-Kahf 92-95 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Between the Two Mountains: The Complaint of Gog and Magog', 'kisah-dzulqarnain-03-antara-dua-gunung-yajuj-majuj', 'en', 'kisah-dzulqarnain', 3, 5, 'Dhul-Qarnayn once more followed a way. He travelled on until he reached a place between two mountains. There he found a people who could scarcely understand speech, on account of their different language and isolation.
...
Reflection: The one whom God has made self-sufficient does not treat doing good as a field for earning wages. Dhul-Qarnayn refused the wealth and instead called the people to work alongside him — for the noblest help is that which empowers others rather than making them dependent. True strength is spent to hold back corruption, not to pile up riches.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 18 AND number = 92), 205, datetime('now');

INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (206, 'Dinding Besi dan Janji Hari Kiamat', 'Tim Editorial ULYAH', 'ebooks/kisah-dzulqarnain/id/kisah-dzulqarnain-04-dinding-penghalang-dan-janji-kiamat.pdf', 5, 'original', 'Ditulis berdasarkan QS. Al-Kahf 96-98 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Dinding Besi dan Janji Hari Kiamat', 'kisah-dzulqarnain-04-dinding-penghalang-dan-janji-kiamat', 'id', 'kisah-dzulqarnain', 4, 5, 'Dzulqarnain mulai membangun. Ia berkata, "Bawalah kepadaku potongan-potongan besi." Maka dikumpulkanlah besi itu hingga ketika telah terkumpul rata memenuhi celah antara dua gunung, ia berkata, "Tiuplah dengan api." Maka mereka meniupnya hingga besi itu menjadi merah membara seperti api. Lalu ia berkata, "Bawakan kepadaku tembaga yang mendidih agar kutuangkan ke atasnya," sehingga besi dan tembaga itu menyatu menjadi dinding yang sangat kuat.
...
Hikmah: Kerja keras dan sarana wajib diusahakan, tetapi keberhasilan adalah rahmat Allah, bukan hasil kehebatan diri. Dzulqarnain membangun dinding terkuat, lalu menyebutnya "rahmat dari Tuhanku" dan mengingat bahwa ia pun akan runtuh pada waktunya. Inilah adab seorang mukmin: berusaha maksimal, bersandar penuh kepada Allah, dan tidak pernah lupa bahwa dunia beserta segala bangunannya akan berakhir pada hari yang dijanjikan.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 18 AND number = 96), 206, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (207, 'The Iron Barrier and the Promise of the Last Day', 'Tim Editorial ULYAH', 'ebooks/kisah-dzulqarnain/en/kisah-dzulqarnain-04-dinding-penghalang-dan-janji-kiamat.pdf', 5, 'original', 'Ditulis berdasarkan QS. Al-Kahf 96-98 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'The Iron Barrier and the Promise of the Last Day', 'kisah-dzulqarnain-04-dinding-penghalang-dan-janji-kiamat', 'en', 'kisah-dzulqarnain', 4, 5, 'Dhul-Qarnayn began to build. He said, "Bring me sheets of iron." The iron was gathered until, when it had been levelled to fill the gap between the two mountains, he said, "Blow with the bellows." So they blew until the iron glowed red like fire. Then he said, "Bring me molten copper that I may pour over it," so that the iron and copper fused into an immensely strong wall.
