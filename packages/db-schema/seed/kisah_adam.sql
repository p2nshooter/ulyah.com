...
SELECT 'Episode 1: Rencana Khalifah di Bumi', 'kisah-adam-01-khalifah-di-bumi', 'id', 'kisah-adam', 1, 1, 'Kisah manusia bermula dari sebuah pengumuman agung. Allah berfirman kepada para malaikat, "Sesungguhnya Aku hendak menjadikan seorang khalifah (pengganti) di bumi" (QS. Al-Baqarah: 30).
...
Hikmah: manusia diciptakan dengan sebuah tujuan mulia — menjadi khalifah, pengemban amanah di bumi. Dan ketika ilmu kita terbatas, sikap terbaik adalah tunduk kepada Yang Maha Mengetahui.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 2 AND number = 30), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 1: The Plan of a Vicegerent on Earth', 'kisah-adam-01-khalifah-di-bumi', 'en', 'kisah-adam', 1, 1, 'The story of humankind begins with a mighty announcement. Allah said to the angels, "Indeed, I will make upon the earth a vicegerent (a successor)" (Qur''an 2:30).
...
Reflection: the human being was created with a noble purpose — to be a vicegerent, a bearer of trust upon the earth. And when our knowledge is limited, the best posture is submission to the All-Knowing.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 2 AND number = 30), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 2: Adam dan Ilmu Nama-Nama', 'kisah-adam-02-ilmu-nama-nama', 'id', 'kisah-adam', 2, 1, 'Untuk menunjukkan keistimewaan makhluk baru ini, Allah mengajarkan kepada Adam nama-nama (benda) seluruhnya, kemudian Dia perlihatkan kepada para malaikat, seraya berfirman, "Sebutkanlah kepada-Ku nama-nama semua benda ini, jika kamu memang benar!" (QS. Al-Baqarah: 31).
...
Hikmah: kemuliaan manusia terletak pada ilmu. Dengan ilmulah Adam mengungguli para malaikat pada momen itu — dan dengan ilmu pula manusia mampu memikul amanah sebagai khalifah.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 2 AND number = 31), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 2: Adam and the Knowledge of the Names', 'kisah-adam-02-ilmu-nama-nama', 'en', 'kisah-adam', 2, 1, 'To show the distinction of this new creation, Allah taught Adam the names of all things, then presented them to the angels, saying, "Inform Me of the names of these, if you are truthful" (2:31).
...
Reflection: the nobility of the human being lies in knowledge. It was through knowledge that Adam surpassed the angels at that moment — and through knowledge that humankind is able to carry the trust of vicegerency.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 2 AND number = 31), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 3: Perintah Sujud dan Kesombongan Iblis', 'kisah-adam-03-sujud-dan-kesombongan-iblis', 'id', 'kisah-adam', 3, 1, 'Allah berfirman, "Sungguh, Kami telah menciptakan kamu (Adam), kemudian membentuk rupamu, lalu Kami berfirman kepada para malaikat, ‘Bersujudlah kamu kepada Adam’; maka mereka pun bersujud, kecuali Iblis. Ia tidak termasuk mereka yang bersujud" (QS. Al-A''raf: 11).
...
Hikmah: kesombongan adalah pintu pertama menuju kehancuran. Iblis tidak menjadi terkutuk karena kebodohan, melainkan karena keangkuhan yang menolak tunduk kepada perintah Allah.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 11), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 3: The Command to Prostrate and Iblis''s Arrogance', 'kisah-adam-03-sujud-dan-kesombongan-iblis', 'en', 'kisah-adam', 3, 1, 'Allah said, "We created you (Adam), then shaped you, then said to the angels, ''Prostrate to Adam''; so they prostrated, except Iblis. He was not among those who prostrated" (7:11).
...
Reflection: arrogance is the first doorway to ruin. Iblis was not cursed for ignorance, but for the pride that refused to submit to Allah''s command.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 11), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 4: Kehidupan di Surga dan Bisikan Godaan', 'kisah-adam-04-godaan-di-surga', 'id', 'kisah-adam', 4, 1, 'Allah berfirman, "Wahai Adam, tinggallah engkau dan istrimu di dalam surga, maka makanlah oleh kamu berdua (buah-buahan) di mana saja yang kamu sukai, tetapi janganlah kamu berdua mendekati pohon yang satu ini, nanti kamu berdua termasuk orang-orang yang zalim" (QS. Al-A''raf: 19). Satu larangan di tengah kelapangan yang tak terhingga.
...
Hikmah: setan selalu menyamar sebagai penasihat yang tulus, bahkan bersumpah atas nama kebaikan. Waspadalah — sering kali godaan datang dengan bungkus nasihat dan janji manis.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 19), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 4: Life in the Garden and the Whisper of Temptation', 'kisah-adam-04-godaan-di-surga', 'en', 'kisah-adam', 4, 1, 'Allah said, "O Adam, dwell you and your wife in the Garden, and eat from wherever you wish, but do not approach this one tree, lest you be among the wrongdoers" (7:19). A single prohibition amid a boundless abundance.
...
Reflection: Satan always disguises himself as a sincere adviser, even swearing in the name of good. Beware — temptation often arrives wrapped in counsel and sweet promises.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 19), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 5: Tobat Adam dan Rahmat Allah', 'kisah-adam-05-tobat-adam', 'id', 'kisah-adam', 5, 1, 'Inilah yang membedakan Adam dari Iblis. Ketika Iblis membela kesalahannya dengan kesombongan, Adam dan istrinya justru mengakui kesalahan mereka dengan rendah hati. Keduanya berdoa, "Ya Tuhan kami, kami telah menzalimi diri kami sendiri. Jika Engkau tidak mengampuni kami dan memberi rahmat kepada kami, niscaya kami termasuk orang-orang yang rugi" (QS. Al-A''raf: 23).
...
Hikmah: dosa bukanlah akhir bagi orang yang mau bertobat. Perbedaan antara Adam dan Iblis bukan pada kesalahannya, melainkan pada tanggapan atas kesalahan itu — Adam mengakui dan bertobat, sedangkan Iblis membela diri dengan angkuh.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 23), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 5: Adam''s Repentance and Allah''s Mercy', 'kisah-adam-05-tobat-adam', 'en', 'kisah-adam', 5, 1, 'Here is what set Adam apart from Iblis. Where Iblis defended his sin with pride, Adam and his wife humbly admitted their fault. They prayed, "Our Lord, we have wronged ourselves. If You do not forgive us and have mercy upon us, we will surely be among the losers" (7:23).
...
Reflection: sin is not the end for one who is willing to repent. The difference between Adam and Iblis was not in the mistake, but in the response to it — Adam admitted it and repented, while Iblis defended himself with arrogance.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 23), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 6: Pesan untuk Anak Cucu Adam', 'kisah-adam-06-anak-cucu-adam', 'id', 'kisah-adam', 6, 1, 'Setelah menuturkan kisah Adam, Allah berbicara langsung kepada seluruh keturunannya — yaitu kita semua. "Wahai anak cucu Adam! Sesungguhnya Kami telah menyediakan pakaian untuk menutupi auratmu dan untuk perhiasan bagimu. Tetapi pakaian takwa, itulah yang lebih baik. Demikianlah sebagian dari tanda-tanda kekuasaan Allah, mudah-mudahan mereka ingat" (QS. Al-A''raf: 26).
...
Hikmah: kisah Adam bukan sekadar cerita masa lampau, melainkan cermin bagi kita. Musuh yang sama yang menggelincirkan Adam masih terus berusaha, dan pakaian terbaik seorang manusia bukanlah kain, melainkan takwa kepada Allah.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 26), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 6: A Message to the Children of Adam', 'kisah-adam-06-anak-cucu-adam', 'en', 'kisah-adam', 6, 1, 'After relating the story of Adam, Allah speaks directly to all his descendants — that is, to all of us. "O children of Adam! We have provided for you clothing to cover your nakedness and as adornment. But the clothing of God-consciousness (taqwa) — that is best. These are among the signs of Allah, that they may remember" (7:26).
...
Reflection: the story of Adam is not merely a tale of the past but a mirror for us. The same enemy who caused Adam to slip is still at work, and the finest garment of a human being is not cloth but consciousness of Allah.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 7 AND number = 26), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 7: Adam Diciptakan dari Tanah dan Ditiupkan Ruh', 'kisah-adam-07-penciptaan-dari-tanah', 'id', 'kisah-adam', 7, 1, 'Sebelum kisah di surga, ada awal yang lebih mendasar: dari apa manusia pertama dibentuk. Allah berfirman, "Dan sungguh, Kami telah menciptakan manusia (Adam) dari tanah liat kering yang berasal dari lumpur hitam yang diberi bentuk" (QS. Al-Hijr: 26). Manusia yang kelak menjadi khalifah itu bermula dari materi yang paling sederhana — tanah.
...
Hikmah: kemuliaan manusia bukan pada bahan asalnya yang hina, melainkan pada ruh yang ditiupkan Allah ke dalam dirinya. Jasad dari tanah, tetapi ruh adalah amanah agung dari Sang Pencipta — di sanalah letak kehormatan sekaligus tanggung jawab manusia.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 15 AND number = 26), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 7: Adam Created from Clay and Given the Spirit', 'kisah-adam-07-penciptaan-dari-tanah', 'en', 'kisah-adam', 7, 1, 'Before the story in the Garden, there is a more fundamental beginning: from what the first human was formed. Allah said, "And We certainly created man (Adam) out of clay from an altered black mud" (Qur''an 15:26). The one who would become vicegerent began from the humblest material — earth.
...
Reflection: the nobility of the human being lies not in the lowly matter he came from, but in the spirit Allah breathed into him. The body is from clay, but the spirit is a mighty trust from the Creator — and there lies both a person''s honor and their responsibility.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 15 AND number = 26), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 8: Sumpah Iblis dan Hamba-Hamba yang Terjaga', 'kisah-adam-08-sumpah-iblis', 'id', 'kisah-adam', 8, 1, 'Setelah menolak sujud dan menerima kutukan, Iblis tidak bertobat — ia justru menyatakan perang terhadap anak cucu Adam. Ia berkata, "Ya Tuhanku, oleh karena Engkau telah menetapkan aku sesat, aku akan menjadikan (kejahatan) terasa indah bagi mereka di bumi, dan aku akan menyesatkan mereka semuanya" (QS. Al-Hijr: 39).
...
Hikmah: musuh manusia telah bersumpah terang-terangan, tetapi ia mengakui sendiri bahwa ada benteng yang tak bisa ia tembus — yaitu hati hamba yang ikhlas kepada Allah. Keikhlasan adalah perlindungan; semakin murni niat seseorang hamba, semakin kecil celah bagi bisikan setan.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 15 AND number = 39), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 8: The Vow of Iblis and the Servants Who Are Protected', 'kisah-adam-08-sumpah-iblis', 'en', 'kisah-adam', 8, 1, 'After refusing to prostrate and receiving the curse, Iblis did not repent — instead he declared war on the children of Adam. He said, "My Lord, because You have put me in error, I will surely make [disobedience] attractive to them on the earth, and I will mislead them all" (Qur''an 15:39).
...
Reflection: the enemy of humankind has sworn openly, yet he admits himself that there is a fortress he cannot breach — the heart of a servant sincere to Allah. Sincerity is protection; the purer a servant''s intention, the smaller the opening for Satan''s whisper.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 15 AND number = 39), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 9: Dua Putra Adam dan Dua Kurban', 'kisah-adam-09-dua-putra-adam', 'id', 'kisah-adam', 9, 1, 'Kehidupan di bumi pun dimulai, dan ujian berpindah kepada keturunan Adam. Allah berfirman, "Dan ceritakanlah (Muhammad) yang sebenarnya kepada mereka tentang kisah kedua putra Adam, ketika keduanya mempersembahkan kurban, maka (kurban) salah seorang dari mereka (Habil) diterima dan dari yang lain (Qabil) tidak diterima" (QS. Al-Ma''idah: 27).
...
Hikmah: iri hati (hasad) adalah api yang membakar pelakunya lebih dulu. Kurban yang diterima Allah bukanlah yang paling banyak atau paling mahal, melainkan yang lahir dari ketakwaan. Dan keberanian sejati kadang justru terletak pada menahan tangan, bukan mengangkatnya.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 5 AND number = 27), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 9: The Two Sons of Adam and the Two Offerings', 'kisah-adam-09-dua-putra-adam', 'en', 'kisah-adam', 9, 1, 'Life on earth now began, and the test passed to Adam''s descendants. Allah said, "And recite to them the story of Adam''s two sons, in truth, when they both offered a sacrifice, and it was accepted from one of them (Habil/Abel) but was not accepted from the other (Qabil/Cain)" (Qur''an 5:27).
...
Reflection: envy (hasad) is a fire that burns the one who carries it first. The offering Allah accepts is not the largest or costliest, but the one born of God-consciousness. And true courage sometimes lies precisely in holding back the hand, not raising it.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 5 AND number = 27), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 10: Kejahatan Pertama di Bumi dan Burung Gagak', 'kisah-adam-10-kejahatan-pertama-dan-burung-gagak', 'id', 'kisah-adam', 10, 1, 'Peringatan sang saudara tidak menghentikan nafsu yang telah dikuasai iri. Allah berfirman, "Maka nafsu (Qabil) mendorongnya untuk membunuh saudaranya, kemudian dia pun (benar-benar) membunuhnya, maka jadilah dia termasuk orang yang rugi" (QS. Al-Ma''idah: 30). Inilah darah pertama yang tertumpah di muka bumi — persis kekhawatiran yang dahulu ditanyakan para malaikat.
...
Hikmah: dosa besar sering bermula dari perasaan kecil yang dibiarkan tumbuh — iri yang tidak dilawan. Penyesalan setelah perbuatan tidak dapat mengembalikan yang telah hilang; karena itu, tempat terbaik untuk menghentikan kejahatan adalah pada bisikan pertamanya, bukan pada akibatnya.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 5 AND number = 30), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 10: The First Crime on Earth and the Crow', 'kisah-adam-10-kejahatan-pertama-dan-burung-gagak', 'en', 'kisah-adam', 10, 1, 'The brother''s warning did not stop a soul already ruled by envy. Allah said, "And his soul permitted to him the murder of his brother, so he killed him and became among the losers" (Qur''an 5:30). This was the first blood spilled upon the earth — exactly the concern the angels had once raised.
...
Reflection: great sin often begins as a small feeling left to grow — an envy never resisted. Regret after the deed cannot return what is lost; so the best place to stop a wrong is at its first whisper, not at its consequence.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 5 AND number = 30), NULL, datetime('now');

INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 11: Janji Petunjuk yang Abadi bagi Anak Cucu Adam', 'kisah-adam-11-petunjuk-bagi-anak-cucu-adam', 'id', 'kisah-adam', 11, 1, 'Kisah Adam ditutup bukan dengan keputusasaan, melainkan dengan sebuah janji yang berlaku hingga akhir zaman. Ketika menurunkan Adam dan keturunannya ke bumi, Allah berfirman, "Turunlah kamu semua dari surga! Kemudian jika benar-benar datang petunjuk-Ku kepadamu, maka barangsiapa mengikuti petunjuk-Ku, tidak ada rasa takut pada mereka dan mereka tidak bersedih hati" (QS. Al-Baqarah: 38).
...
Hikmah: sejak Adam diturunkan, pintu petunjuk tidak pernah ditutup. Setiap manusia adalah anak Adam yang mewarisi janji ini — bahwa siapa pun yang kembali kepada petunjuk Allah akan menemukan ketenangan, betapapun jauh ia sempat tersesat. Inilah warisan terbesar dari kisah bapak seluruh manusia.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 2 AND number = 38), NULL, datetime('now');
INSERT OR IGNORE INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Episode 11: The Eternal Promise of Guidance for Adam''s Children', 'kisah-adam-11-petunjuk-bagi-anak-cucu-adam', 'en', 'kisah-adam', 11, 1, 'The story of Adam closes not in despair, but with a promise that holds until the end of time. As He sent Adam and his descendants down to the earth, Allah said, "Go down from it, all of you. And when guidance comes to you from Me, whoever follows My guidance — there will be no fear concerning them, nor will they grieve" (Qur''an 2:38).
