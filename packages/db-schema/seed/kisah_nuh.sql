...
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (400, 'Nabi Nuh Diutus dan Ditolak Kaumnya', 'Tim Editorial ULYAH', 'ebooks/kisah-nuh/id/kisah-nuh-01-diutus-dan-ditolak.pdf', 1, 'original', 'Ditulis berdasarkan QS. Hud 25-31 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
...
SELECT 'Nabi Nuh Diutus dan Ditolak Kaumnya', 'kisah-nuh-01-diutus-dan-ditolak', 'id', 'kisah-nuh', 1, 1, 'Allah mengutus Nabi Nuh kepada kaumnya. Ia berkata, "Sesungguhnya aku adalah pemberi peringatan yang nyata bagi kalian, agar kalian tidak menyembah selain Allah. Sungguh, aku khawatir kalian akan ditimpa azab pada hari yang pedih."
...
Hikmah: Nuh tidak menilai pengikutnya dari status sosial mereka, sebab iman bukan perkara kedudukan dunia. Ia juga menolak untuk mengusir orang-orang lemah yang beriman demi menyenangkan para pembesar yang sombong — sebuah pelajaran bahwa kebenaran tidak boleh dikorbankan demi kedudukan atau penerimaan orang banyak.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 25), 400, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (401, 'Noah Is Sent, and His People Reject Him', 'Tim Editorial ULYAH', 'ebooks/kisah-nuh/en/kisah-nuh-01-diutus-dan-ditolak.pdf', 1, 'original', 'Ditulis berdasarkan QS. Hud 25-31 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Noah Is Sent, and His People Reject Him', 'kisah-nuh-01-diutus-dan-ditolak', 'en', 'kisah-nuh', 1, 1, 'God sent Noah to his people. He said, "Indeed, I am to you a clear warner, that you worship none but Allah. Indeed, I fear for you the punishment of a painful day."
...
Reflection: Noah did not judge his followers by their social standing, for faith is never a matter of worldly rank. He also refused to drive away the weak believers merely to please the arrogant elite — a lesson that truth must never be traded away for status or popular approval.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 25), 401, datetime('now');

INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (402, 'Kaumnya Menantang Datangnya Azab', 'Tim Editorial ULYAH', 'ebooks/kisah-nuh/id/kisah-nuh-02-tantangan-kaumnya.pdf', 1, 'original', 'Ditulis berdasarkan QS. Hud 32-34 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Kaumnya Menantang Datangnya Azab', 'kisah-nuh-02-tantangan-kaumnya', 'id', 'kisah-nuh', 2, 1, 'Kaum Nuh yang telah lelah mendengar seruannya berkata, "Wahai Nuh, engkau telah membantah kami, dan sudah terlalu banyak membantah kami. Maka datangkanlah kepada kami azab yang engkau ancamkan itu, jika engkau termasuk orang-orang yang benar."
...
Hikmah: Ketika manusia menantang azab Allah dengan sombong, seorang mukmin sejati tidak membalas dengan amarah, melainkan mengembalikan segala urusan kepada kehendak Allah semata. Nuh mengajarkan bahwa hidayah adalah murni karunia Allah — betapa pun gigihnya seorang dai berdakwah, hati yang dikehendaki-Nya tersesat tidak akan tergerak oleh nasihat manusia.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 32), 402, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (403, 'His People Challenge Him to Bring the Punishment', 'Tim Editorial ULYAH', 'ebooks/kisah-nuh/en/kisah-nuh-02-tantangan-kaumnya.pdf', 1, 'original', 'Ditulis berdasarkan QS. Hud 32-34 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'His People Challenge Him to Bring the Punishment', 'kisah-nuh-02-tantangan-kaumnya', 'en', 'kisah-nuh', 2, 1, 'Noah''s people, weary of his call, said, "O Noah, you have disputed us and been frequent in dispute of us. So bring us what you threaten us with, if you should be of the truthful."
...
Reflection: When people arrogantly challenge God''s punishment, a true believer does not answer with anger but returns every matter to God''s will alone. Noah teaches that guidance is purely God''s gift — no matter how persistent a caller to truth may be, a heart God has left to stray will not be moved by human persuasion.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 32), 403, datetime('now');

INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (404, 'Perintah Membangun Bahtera', 'Tim Editorial ULYAH', 'ebooks/kisah-nuh/id/kisah-nuh-03-perintah-membangun-bahtera.pdf', 1, 'original', 'Ditulis berdasarkan QS. Hud 36-41 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Perintah Membangun Bahtera', 'kisah-nuh-03-perintah-membangun-bahtera', 'id', 'kisah-nuh', 3, 1, 'Allah mewahyukan kepada Nuh, "Tidak akan ada lagi di antara kaummu yang beriman selain orang yang telah beriman sebelumnya. Maka janganlah engkau bersedih hati atas apa yang selalu mereka perbuat."
...
Hikmah: Ketaatan sejati kepada Allah kadang berarti bersabar menghadapi ejekan orang banyak sementara kita tetap mengerjakan apa yang diperintahkan-Nya, meski tampak tidak masuk akal di mata mereka (membangun kapal jauh dari air). Nuh tidak berhenti bekerja hanya karena diolok-olok — ia meneruskan perintah Allah dengan penuh keyakinan bahwa kebenaran akan terbukti pada waktunya.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 36), 404, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (405, 'The Command to Build the Ark', 'Tim Editorial ULYAH', 'ebooks/kisah-nuh/en/kisah-nuh-03-perintah-membangun-bahtera.pdf', 1, 'original', 'Ditulis berdasarkan QS. Hud 36-41 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'The Command to Build the Ark', 'kisah-nuh-03-perintah-membangun-bahtera', 'en', 'kisah-nuh', 3, 1, 'It was revealed to Noah, "No one will believe from your people except those who have already believed, so do not be distressed by what they have been doing."
...
Reflection: True obedience to God sometimes means patiently bearing the mockery of others while still carrying out what He has commanded, even when it appears senseless in their eyes — building a ship far from any water. Noah did not stop working merely because he was ridiculed; he carried on with God''s command, fully certain the truth would prove itself in time.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 36), 405, datetime('now');

INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (406, 'Banjir Besar dan Anak Nuh yang Enggan Naik', 'Tim Editorial ULYAH', 'ebooks/kisah-nuh/id/kisah-nuh-04-banjir-besar-dan-anak-nuh.pdf', 1, 'original', 'Ditulis berdasarkan QS. Hud 40-44 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Banjir Besar dan Anak Nuh yang Enggan Naik', 'kisah-nuh-04-banjir-besar-dan-anak-nuh', 'id', 'kisah-nuh', 4, 1, 'Hingga ketika perintah Kami datang dan dapur (permukaan bumi) telah memancarkan air (sebagai tanda dimulainya azab), Allah berfirman, "Muatkanlah ke dalam kapal itu sepasang dari setiap jenis makhluk, juga keluargamu — kecuali orang yang telah lebih dahulu ditetapkan (akan binasa) di antara mereka — dan muatkan pula orang-orang yang beriman." Padahal tidak ada yang beriman bersamanya kecuali sedikit.
...
Hikmah: Keselamatan di sisi Allah tidak ditentukan oleh hubungan darah, melainkan oleh iman dan ketaatan. Anak Nuh memilih berlindung pada gunung — sesuatu yang tampak logis di mata manusia — namun tidak ada perlindungan sejati kecuali rahmat Allah. Inilah pelajaran besar bahwa nasab yang mulia tidak menyelamatkan seseorang tanpa iman yang benar.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 40), 406, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (407, 'The Great Flood, and Noah''s Son Who Refused to Board', 'Tim Editorial ULYAH', 'ebooks/kisah-nuh/en/kisah-nuh-04-banjir-besar-dan-anak-nuh.pdf', 1, 'original', 'Ditulis berdasarkan QS. Hud 40-44 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'The Great Flood, and Noah''s Son Who Refused to Board', 'kisah-nuh-04-banjir-besar-dan-anak-nuh', 'en', 'kisah-nuh', 4, 1, 'So it was, until when Our command came and the earth''s surface overflowed with water, God said, "Load upon the ship of each creature two mates and your family — except those about whom the word has preceded — and include whoever has believed." But none had believed with him, except a few.
...
Reflection: Salvation in God''s sight is never determined by blood ties, but by faith and obedience. Noah''s son chose refuge on a mountain — a choice that seemed reasonable by human logic — yet there is no true refuge except God''s mercy. This is the great lesson that noble lineage alone cannot save anyone without genuine faith.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 40), 407, datetime('now');

INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (408, 'Doa Nabi Nuh dan Penyelesaian Perkara', 'Tim Editorial ULYAH', 'ebooks/kisah-nuh/id/kisah-nuh-05-doa-nuh-dan-penyelesaian.pdf', 1, 'original', 'Ditulis berdasarkan QS. Hud 45-49 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Doa Nabi Nuh dan Penyelesaian Perkara', 'kisah-nuh-05-doa-nuh-dan-penyelesaian', 'id', 'kisah-nuh', 5, 1, 'Nuh berseru kepada Tuhannya, "Ya Tuhanku, sesungguhnya anakku termasuk keluargaku, dan sesungguhnya janji-Mu itu benar. Engkaulah hakim yang paling adil."
...
Hikmah: Bahkan seorang nabi bisa keliru dalam memahami janji Allah jika dipahami secara harfiah tanpa memperhatikan syarat keimanan. Nuh segera bertobat dan memohon ampun begitu diberi pengertian oleh Allah — sebuah teladan tentang kerendahan hati seorang nabi yang tidak mempertahankan pendapatnya sendiri di hadapan wahyu, dan segera kembali kepada kebenaran begitu ia tersingkap.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 45), 408, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (409, 'Noah''s Prayer and the Resolution', 'Tim Editorial ULYAH', 'ebooks/kisah-nuh/en/kisah-nuh-05-doa-nuh-dan-penyelesaian.pdf', 1, 'original', 'Ditulis berdasarkan QS. Hud 45-49 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Noah''s Prayer and the Resolution', 'kisah-nuh-05-doa-nuh-dan-penyelesaian', 'en', 'kisah-nuh', 5, 1, 'Noah called to his Lord and said, "My Lord, indeed my son is of my family, and indeed Your promise is true, and You are the most just of judges."
...
Reflection: Even a prophet can misunderstand God''s promise if it is taken literally without regard to the condition of faith. Noah repented and sought forgiveness the instant God clarified the matter for him — a model of humility, refusing to defend his own opinion in the face of revelation, and returning to the truth the moment it was made clear.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 11 AND number = 45), 409, datetime('now');

INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (410, 'Seruan Nabi Nuh Siang dan Malam', 'Tim Editorial ULYAH', 'ebooks/kisah-nuh/id/kisah-nuh-06-seruan-siang-dan-malam.pdf', 1, 'original', 'Ditulis berdasarkan QS. Nuh 1-14 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Seruan Nabi Nuh Siang dan Malam', 'kisah-nuh-06-seruan-siang-dan-malam', 'id', 'kisah-nuh', 6, 1, 'Sesungguhnya Kami telah mengutus Nuh kepada kaumnya, "Berilah peringatan kepada kaummu sebelum datang kepada mereka azab yang pedih." Nuh berkata, "Wahai kaumku, sesungguhnya aku adalah pemberi peringatan yang nyata bagi kalian, (yaitu) sembahlah Allah, bertakwalah kepada-Nya, dan taatlah kepadaku. Niscaya Allah akan mengampuni sebagian dosa-dosa kalian dan menangguhkan kalian sampai waktu yang ditentukan. Sesungguhnya ketetapan Allah apabila telah datang tidak dapat ditunda, sekiranya kalian mengetahui."
...
Hikmah: Kegigihan dakwah Nuh selama bertahun-tahun — siang dan malam, terang-terangan maupun diam-diam — adalah teladan kesabaran seorang dai. Ia tidak pernah lelah mengajak kaumnya kepada ampunan Allah, meski mereka menutup telinga dan menolaknya berulang kali. Dakwah yang tulus tidak diukur dari hasil yang segera, melainkan dari ketekunan menyampaikannya.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 71 AND number = 1), 410, datetime('now');
INSERT INTO ebooks (id, title, author, r2_key, category_id, license_status, license_note) VALUES (411, 'Noah''s Call, Day and Night', 'Tim Editorial ULYAH', 'ebooks/kisah-nuh/en/kisah-nuh-06-seruan-siang-dan-malam.pdf', 1, 'original', 'Ditulis berdasarkan QS. Nuh 1-14 (quran-json, CC-BY-4.0). Tidak ada kutipan pihak ketiga berhak cipta.');
INSERT INTO stories (title, slug, lang, series_key, episode_number, category_id, body, ai_generated, qc_status, source_format, status, confidence_score, related_ayah_id, pdf_ebook_id, published_at)
SELECT 'Noah''s Call, Day and Night', 'kisah-nuh-06-seruan-siang-dan-malam', 'en', 'kisah-nuh', 6, 1, 'Indeed, We sent Noah to his people, saying, "Warn your people before there comes to them a painful punishment." Noah said, "O my people, indeed I am to you a clear warner — worship Allah, fear Him, and obey me. He will forgive you your sins and delay you for a specified term. Indeed, the time set by Allah, when it comes, will not be delayed, if you only knew."
...
Reflection: At the end of his long da''wah, Noah did not surrender to despair but closed it with an expansive prayer — seeking forgiveness not only for himself, but for his parents and for every believer across all ages. This is the model of a true caller to God: a heart forever bound to the good of the ummah, even after facing rejection so long and so heavy.', 0, 'qc_pending', 'ai_original', 'published', 1.0,
  (SELECT id FROM ayah WHERE surah_id = 71 AND number = 15), 413, datetime('now');
